...
export class TouchDraggable<E extends SVGElement> implements Draggable {
  ...
  constructor(private element: E, private handlers: Handlers) {
    document.addEventListener("touchstart", this._onTouchStart, passive);
  ...
  private _onTouchMove = (e: TouchEvent) => {
    ...
    this.handlers.onDrag(clientX - x, clientY - y, clientX, clientY, e);
  };
  ...
  private _onTouchEnd = (e: TouchEvent) => {
    ...
    this.handlers.onDragEnd(clientX - x, clientY - y, e);
